...
HeterotrophPopulation::HeterotrophPopulation(Nutrient* nutrient, Parameters* params, const std::float64_t initialVolume,
...
void HeterotrophPopulation::populate(const std::float64_t volumeToInitialise, const std::float64_t assimilationEfficiency,
...
void HeterotrophPopulation::whoIsMoving(std::vector<MovingHeterotroph>& movingHeterotrophs) {
...
std::float64_t HeterotrophPopulation::getSizeClassUpper() {
  return sizeClassUpper_;
}

std::float64_t HeterotrophPopulation::getSizeClassMidPoint() {
  return sizeClassMidPoint_;
}

std::float64_t HeterotrophPopulation::getSizeClassLower() {
